...
Следующий логичный блок — ручная админская выдача конфигов выбранному пользователю:
выбор клиента или пользователя, отправка config-файлов и логирование факта выдачи.
