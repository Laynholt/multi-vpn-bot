...
- этап 18 начат: добавлена ручная админская выдача VPN-конфигов через команду
  ...
  оставляет отправку отдельными файлами; карточка пользователя в админке получила
  inline-кнопку `Выдать конфиги`.
...
Следующий логичный блок — добавить inline-выдачу одного конфига из карточки VPN-клиента
и затем переходить к мониторингу/фоновым задачам этапа 19.
