...
- этап 18 начат: добавлена ручная админская выдача VPN-конфигов через команду
  ...
  выбранному пользователю и audit-log факта выдачи.
...
Следующий логичный блок — расширить выдачу конфигов архивами и явным аудитом в БД:
пакетная отправка, история выдач и удобные админские callbacks поверх текущей команды.
